...
public class EmployeeInfo extends javax.swing.JFrame {
    ...
    public void Connect()
    {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/employeinfo","root","");
    ...
    private void initComponents() {
        ...
        txtFname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
        ...
        txtLname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
        ...
        txtCity.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
        ...
        txtphone.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
        ...
        txtsalary.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
        ...
        txtnid.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtnid.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 0, 204), 1, true));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29)
                        .addComponent(txtnid, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "City", "Phone", "salary", "Nid"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String fname,lname,city,phone,salary,nid;
            ...
            nid = txtnid.getText();
            pst = con.prepareStatement("update records set fname=?,lname=?,city=?,phone=?,salary=?,nid=? where id=?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            salary = txtsalary.getText();
            nid = txtnid.getText();
            pst = con.prepareStatement("insert  into records (fname,lname,city,phone,salary,nid)values(?,?,?,?,?,?)");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtnid.setText(model.getValueAt(selectedIndex, 6).toString());
